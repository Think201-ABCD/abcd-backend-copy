...
export const Validate: any = (reqType: string) => {
    switch (reqType) {
                ...
                body("title")
                    ...
                    .custom(
                        async (value: any, { req }: any) =>
                            await validateTitle(Behaviour, value, req.body.uuid ? req.body.uuid : null)
                    ),
        ...
        case "putBehaviourCountry": {
            return [
                param("uuid").notEmpty().withMessage("Invalid request").bail().isUUID().withMessage("Invalid request"),

                body("behaviour_countries")
                    .notEmpty()
                    .withMessage("Please enter the country specific details for the behaviour")
                    .bail()
                    .isArray()
                    .withMessage("Invalid request"),

                body("behaviour_countries.*.country_id")
                    .notEmpty()
                    .withMessage("Please select the country")
                    .bail()
                    .isInt({ min: 1 })
                ...
                body("behaviour_countries.*.brief")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                ...
                body("behaviour_countries.*.description")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please enter the country specific description for the behaviour")
                    .bail()
                    .isLength({ min: 10 })
                    .withMessage("Description must be 10 or more characters"),

                body("behaviour_countries.*.media")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please upload the media for the country behaviour")
                    .bail()
                    .isArray()
                    .withMessage("Invalid media uploaded"),

                body("behaviour_countries.*.media.*.type")
                    .isIn([
                        "video",
                        "image",
                        "audio",
                ...
                body("behaviour_countries.*.media.*.file")
                    .notEmpty()
                ...
                body("behaviour_countries.*.media.*.file_name")
                    .optional()
                    .notEmpty()
        ...
        case "putBehaviourStates": {
            return [
                param("uuid").notEmpty().withMessage("Invalid request").bail().isUUID().withMessage("Invalid request"),

                body("behaviour_states")
                    .notEmpty()
                ...
                body("behaviour_states.*.state_id")
                    .notEmpty()
                ...
                body("behaviour_states.*.description")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                ...
                body("behaviour_states.*.prevalence")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please enter the prevalence data"),

                body("behaviour_states.*.media")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                ...
                body("behaviour_states.*.media.*.type")
                    .isIn([
                        "video",
                        "image",
                        "audio",
                ...
                body("behaviour_states.*.media.*.file")
                    .notEmpty()
                    .withMessage("Please upload the media file")
                    .bail()
                    .isLength({ max: 255 })
                ...
                body("behaviour_states.*.media.*.file_name")
                    .optional()
                    .notEmpty()
                    .withMessage("Please upload the media file name")
                    .bail()
