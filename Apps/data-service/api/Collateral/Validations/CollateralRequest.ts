    ...
    switch (reqType) {
        ...
        case "postCollateral": {
            return [
                ...
                body("title")
                    ...
                    .custom(
                        async (value: any, { req }: any) =>
                            await validateTitle(Collateral, value, req.body.uuid ? req.body.uuid : null)
                    ),
                ...
                body("organisations.*").isUUID().withMessage("Invalid organisation uuid selected"),
                ...
                body("license")
                    ...
                    .bail()
                    .isLength({ max: 255 })
                    .withMessage("License type cannot be more than 255 characters"),
        ...
        case "putCollateralCountry": {
            return [
                param("uuid").notEmpty().withMessage("Invalid request").bail().isUUID().withMessage("Invalid request"),

                body("collateral_countries")
                    .notEmpty()
                    .withMessage("Please enter the country specific details for collateral data")
                    .bail()
                    .isArray()
                    .withMessage("Invalid request"),

                body("collateral_countries.*.country_id")
                    .notEmpty()
                    .withMessage("Please select the country")
                    .bail()
                    .isInt({ min: 1 })
                ...
                body("collateral_countries.*.brief")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                ...
                body("collateral_countries.*.description")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please enter the country specific description for collateral data")
                    .bail()
                    .isLength({ min: 10 })
                    .withMessage("Description must be 10 or more characters"),

                body("collateral_countries.*.media")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please upload the media for the country collateral data")
                    .bail()
                    .isArray()
                    .withMessage("Invalid media uploaded"),

                body("collateral_countries.*.media.*.type")
                    .isIn([
                        "video",
                        "image",
                        "audio",
                ...
                body("collateral_countries.*.media.*.file")
                    .notEmpty()
                ...
                body("collateral_countries.*.media.*.file_name")
                    .optional()
                    .notEmpty()
        ...
        case "putCollateralStates": {
            return [
                ...
                body("collateral_states").optional({ checkFalsy: true }).isArray().withMessage("Invalid request"),

                body("collateral_states.*.state_id")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                ...
                body("collateral_states.*.brief")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please enter the state specific brief for the collateral data ")
                    .bail()
                    .isLength({ max: 255 })
                    .withMessage("Brief must be 255 or less characters"),

                body("collateral_states.*.description")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please enter the state specific description for the collateral data ")
                    .bail()
                    .isLength({ min: 10 })
                    .withMessage("Description must be 10 or more characters"),

                body("collateral_states.*.media")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please upload the media for the state collateral data")
                    .bail()
                    .isArray()
                    .withMessage("Invalid media uploaded"),

                body("collateral_states.*.media.*.type")
                    .optional({ checkFalsy: true })
                    .isIn([
                        "video",
                        "image",
                ...
                body("collateral_states.*.media.*.file")
                    .optional({ checkFalsy: true })
                    .notEmpty()
                    .withMessage("Please upload the media file")
                    .bail()
                ...
                body("collateral_states.*.media.*.file_name")
                    .optional()
                    .notEmpty()
                    .withMessage("Please upload the media file name")
                    .bail()
